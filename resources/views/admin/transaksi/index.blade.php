            ...
            <nav class="space-y-2">
                ...
                <div class="space-y-1">
                    ...
                    <div id="menu-laporan" class="overflow-hidden transition-all duration-300 ease-in-out bg-[#0f172a]/40 rounded-xl pl-4 space-y-1" style="max-height: 200px;">
                        <a href="{{ route('admin.transaksi.index') }}" class="flex items-center gap-2 px-3 py-2 text-xs bg-amber-500/10 text-amber-400 border-l-2 border-amber-500 font-semibold transition rounded-lg">
                            <i data-lucide="file-text" class="w-3.5 h-3.5"></i>Riwayat Transaksi
                        </a>
                    </div>
                </div>
            </nav>
