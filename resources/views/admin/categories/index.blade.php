...
<head>
    ...
    <title>BENGKEL MSB - MANAJEMEN KATEGORI</title>
    ...
    <div class="space-y-6 max-w-7xl mx-auto">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-gradient-to-r from-[#1e293b] to-[#111827] border border-slate-800 rounded-2xl p-6 shadow-xl relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-xs text-slate-400">Kelola kelompok data sparepart dan produk bengkel Anda di sini.</p>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-800/40 text-xs">
                        ...
                        <tr class="hover:bg-slate-800/30 transition group">
                            ...
                            <td class="py-3.5 px-4 font-mono font-semibold text-amber-500">{{ $item->kode_kategori }}</td>
                            <td class="py-3.5 px-4 font-semibold text-white group-hover:text-amber-400 transition">{{ $item->nama_kategori }}</td>
                        ...
                        <tr>
                            <td colspan="5" class="py-12 text-center text-slate-500">
                                <div class="flex flex-col items-center justify-center gap-2">
                                    ...
                                    <p class="text-xs font-medium">Data kategori tidak ditemukan atau masih kosong</p>
                                </div>
                            </td>
                        </tr>
                        @endif
