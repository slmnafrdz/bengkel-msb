...
<head>
    ...
    <title>Edit User - Bengkel MSB</title>
    ...
    <main class="flex-1 p-6 overflow-y-auto bg-[#0b0f19]">
        <div class="max-w-lg mx-auto">
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 class="text-xl font-extrabold text-white">Edit User</h1>
                    <p class="text-xs text-slate-400 mt-0.5">Perbarui data akun <span class="text-amber-400 font-semibold">{{ $user->name }}</span>.</p>
                </div>
            </div>
            ...
            <div class="bg-[#0f1629]/60 border border-slate-800/60 rounded-2xl p-6">
                <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="border-t border-slate-800 pt-5">
                            <p class="text-xs text-slate-500 mb-3">Kosongkan password jika tidak ingin mengubahnya.</p>
                            <div class="space-y-4">
                                <div>
                                    <label class="block text-xs font-bold text-slate-400 mb-1.5 uppercase tracking-wide">Password Baru</label>
                                ...
                                <div>
                                    <label class="block text-xs font-bold text-slate-400 mb-1.5 uppercase tracking-wide">Konfirmasi Password Baru</label>
